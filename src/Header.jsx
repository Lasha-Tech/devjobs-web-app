...
const Header = ({click, circle}) => {
    return (
      <HeaderContainer>
        ...
        <HeaderBackground>
        {/* Left  */}
          <HeaderBackgroundSvgLeft xmlns="http://www.w3.org/2000/svg" viewBox="0 0 355 108">
            <SvgPath fillRule="evenodd" clipRule="evenodd" d="M-71.4609 45.7412C-74.5785 13.9487 -41.7496 -9.03826 -12.9407 4.76502L331.22 169.663C359.511 183.219 362.718 222.23 337.02 240.224L30.1041 455.129C4.4064 473.122 -31.1552 456.766 -34.2168 425.545L-71.4609 45.7412Z" fill="white"/>
          </HeaderBackgroundSvgLeft>
        
        {/* Right  */}
          <HeaderBackgroundSvgRight xmlns="http://www.w3.org/2000/svg" viewBox="0 0 121 96">
            <SvgPath fillRule="evenodd" clipRule="evenodd" d="M0.539125 -321.259C-2.57848 -353.051 30.2504 -376.038 59.0593 -362.235L403.22 -197.337C431.511 -183.781 434.718 -144.77 409.02 -126.776L102.104 88.1286C76.4064 106.122 40.8448 89.766 37.7832 58.5447L0.539125 -321.259Z"/>
